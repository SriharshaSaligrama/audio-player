                ...
                {Array.from({ length: 6 }).map((_, i) => (
                    <div key={i} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                        ...
                        <div className="relative h-32 bg-gray-200 dark:bg-gray-700 animate-pulse">
                            ...
                            <div className="absolute bottom-4 left-4 w-[60px] h-[60px] bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"></div>
                            {/* Title and artist placeholder */}
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="h-6 w-14 bg-gray-200 dark:bg-gray-600 rounded-full animate-pulse"></div>
                            </div>
                        </div>
